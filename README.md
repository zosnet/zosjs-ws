# Bitshares websocket interface (zosjs-ws)
...
[![npm version](https://img.shields.io/npm/v/zosjs-ws.svg?style=flat-square)](https://www.npmjs.com/package/zosjs-ws)
[![npm downloads](https://img.shields.io/npm/dm/zosjs-ws.svg?style=flat-square)](https://www.npmjs.com/package/zosjs-ws)
...
```
<script type="text/javascript" src="https://cdn.rawgit.com/bitshares/zosjs-ws/build/zosjs-ws.js" />
```
